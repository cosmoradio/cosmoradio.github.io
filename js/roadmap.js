;var roadmap = ( function(){
    ...
    <p>- а @MTHCKR спасибо за frontend, backend, ботов и парсеры telegram и youtube, игры и прочее</p>
    <p><h5>- Большинство моих коллег настояло на прозрачности сайта, поэтому выбрали GITHUB!</h5></p>
    <p>__________________________________________________________</p>
    <p>👾 cryptoCOVID on may 2019</p>
    <p>👾 @MTHCKR, @jhonyE работали над JS майнером, но в последствии от этой идеи отказались. Средства предполагалось перечислять мало знаменитым левым ютуб блогерам </p>
    ...
    <p>👾 написана REDdump["00_rz_ recruitment_agent_Kwint"]</p>
    <p>👾 переработана визуализация сайта.</p>
    <p>__________________________________________________________</p>
    <p>______________________год_2023______________________</p>
    <p>- За 5 часов @MTHCKR переписал игру linkOfDEATH в игру Буржуй(пока тест)</p>
    ...
    <p>- Переписаны грабберы телеграмм постов: теперь все новости будут транслироваться в группу <a href="https://t.me/radiocosmopolit">https://t.me/radiocosmopolit</a> с указанием источников новостей!</p>
